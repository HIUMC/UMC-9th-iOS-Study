...
class MovieViewModel {
    var movies: [MovieModel] = [
        ...
        MovieModel(posterName: "blade",secPosterName: "f1Poster", name: "극장판 귀멸의칼날",engname:"Demon Slayer: Kimetsu no Yaiba – The Movie: Infinity Castle" ,performance: "1", age: "15"),
